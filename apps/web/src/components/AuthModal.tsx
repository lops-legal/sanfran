    ...
    >
      ...
      >
        ...
        {error && (
          <div
            role="alert"
            className="mb-4 rounded-lg border border-red-500/20 bg-red-500/10 p-3 text-center text-sm text-red-500"
          >
            {error}
          </div>
        )}
        ...
        {/* Divisor: a linha fica atrás (z-0) e o rótulo tem fundo sólido próprio (z-10),
            então o texto nunca aparece "riscado" pela borda, mesmo com blur no fundo. */}
