...
export function AIInputWithSuggestions({
    ...
    return (
        <div className={cn("w-full py-4", className)}>
            <div className="relative max-w-xl w-full mx-auto shadow-2xl">
                <div className="relative border border-white/10 focus-within:border-white/20 rounded-2xl bg-[#111113]">
                    <div className="flex flex-col">
                        ...
                        >
                            <textarea
                                ...
                                className={cn(
                                    "max-w-xl w-full rounded-2xl pr-10 pt-3 pb-3 placeholder:text-slate-500 border-none focus:ring text-white resize-none text-wrap bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 leading-[1.2] outline-none px-4",
                                    `min-h-[${minHeight}px]`
                                )}
                                value={inputValue}
                                onChange={(e) => {
                    ...
                    <CornerRightDown
                        className={cn(
                            "absolute right-3 top-3 w-4 h-4 transition-all duration-200 text-slate-500 cursor-pointer hover:text-white",
                            inputValue
